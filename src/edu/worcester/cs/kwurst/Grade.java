...
{
	/*
	 * Builds a table of letter grades and their numeric equivalents. This uses
	 * the Java HashMap
	 ...
	 * 
	 * @param letterGrade
	 *          the letter grade (A, A-, B+, B, B-, C+, C, C-, D+, D, D-, E, IP).
	...
	public Grade(String letterGrade)
	{
		if(!gradeTable.containsKey(letterGrade))
		{
			throw new IllegalArgumentException(
					letterGrade + " is not a valid letter grade.");
		}
		grade = letterGrade;
	}
	...
	/**
	 * Returns the numeric grade (4.0, 3.7, 3.3, 3.0, 2.7, 2.3, 2.0, 1.7, 1.3,
	 * 1.0, 0.0, 0.0).
	 * 
	 * @return the numeric grade (4.0, 3.7, 3.3, 3.0, 2.7, 2.3, 2.0, 1.7, 1.3,
	 *         1.0, 0.0, 0.0).
	 */
